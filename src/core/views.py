...
def datos_usuarios(request):
      datos_usuarios = [
            {'nombre': 'Ivan', 'email': 'ijmm15@fmail.com'},
            {'nombre': 'Juan', 'email': 'juancho@fmail.com'},
            {'nombre': 'Santi', 'email': 'san_ti@fmail.com'},
      ]
      return render(request, "core/usuarios.html",{"usuarios": datos_usuarios} )      
